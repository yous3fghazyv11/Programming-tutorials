...
#+LATEX_HEADER: \setmainlanguage{arabic}
#+LATEX_HEADER: \setotherlanguage{english}
#+LATEX_HEADER: \newfontfamily\arabicfont[Script=Arabic]{Amiri}
#+LATEX_HEADER: \newfontfamily\englishfont{Latin Modern Roman}
#+LATEX_HEADER: \let\OriginalVerbatim\verbatim
#+LATEX_HEADER: \let\endOriginalVerbatim\endverbatim
#+LATEX_HEADER: \renewenvironment{verbatim}{\begin{english}\OriginalVerbatim}{\endOriginalVerbatim\end{english}}
#+LATEX_HEADER: \renewenvironment{Shaded}{\begin{english}\begin{quote}}{\end{quote}\end{english}}

المحاضره دي هتشرح انواع البيانات في ال ++C او ال Data Types وازاي ناخد data من ال standard input stream او الkeyboard ونفهم يعني ايه data و data types و objects و values و variables
* ازاي ناخد input؟
